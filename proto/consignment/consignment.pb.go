...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_fda75af40f41c400, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_fda75af40f41c400, []int{1}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_fda75af40f41c400, []int{2}
}
...
func init() {
	proto.RegisterFile("proto/consignment/consignment.proto", fileDescriptor_consignment_fda75af40f41c400)
}

var fileDescriptor_consignment_fda75af40f41c400 = []byte{
