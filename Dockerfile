...
WORKDIR /go/src/bitbucket.org/dillonlpeterson/shippy/consignment-service
...
COPY --from=builder /go/src/bitbucket.org/dillonlpeterson/shippy/consignment-service/consignment-service .
